...
import { PerformanceAlert } from './entities/performance-alert.schema';
...
export class AlertsController {
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'If "true" or "1", return only unread alerts',
  })
  @ApiResponse({
    status: 200,
    description: 'List of performance alerts (newest first)',
